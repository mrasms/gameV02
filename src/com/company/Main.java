...
public class Main {
    ...
    public static int[] heroesHealth = {300, 280, 250, 200, 1000};
    public static int[] heroesDamage = {20, 15, 25, 20, 10};
    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Lucky", "Golem"};
    public static int bossHealth = 1900;
